...
| ------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| Signed critical-path smoke passed                 | Signed app installed, launched, created a session, generated 10 documents, and exported 12 files to `~/Projects/auraforge-signed-smoke-export/i-want-to-build-a-small-desktop-tool-called-smokenotes-for-c-plan` | Closed |
